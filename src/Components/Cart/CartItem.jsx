...
import { setClearCartItems, setDecreaseItemQTY, setIncreaseItemQTY, setRemoveItemFromCart } from '../../App/CartSlice'
import { useDispatch } from 'react-redux'

function CartItem( {item: { id, title, text, img, color, shadow, price, cartQuantity } }) {
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              <button onClick={DecraseQTY} type="button"  className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90">
              ...
              <button onClick={ IncreaseQTY} type="button"  className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90">
